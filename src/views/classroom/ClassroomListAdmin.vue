<template>
  <div class="h-100">
    ...
    <template v-if="!classroomsFilter.length">
...
export default {
  ...
  computed: {
    ...
    classroomsFilter() {
      if (this.filterClassroom === null) {
        return this.classrooms;
      } else {
        return this.classrooms.filter(
          (el) => el.statusActive === this.filterClassroom
        );
      }
    },
    nameAttacder() {
